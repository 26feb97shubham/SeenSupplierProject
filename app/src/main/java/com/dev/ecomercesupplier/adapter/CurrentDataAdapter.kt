...
class CurrentDataAdapter(private val context: Context, private val data:ArrayList<OrderData>, private val clickInstance: ClickInterface.ClickPosInterface): RecyclerView.Adapter<CurrentDataAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view =
            LayoutInflater.from(context).inflate(R.layout.item_current_data, parent, false)

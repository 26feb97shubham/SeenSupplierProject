...
class NewImageVideoAdapter (private val context: Context, private val data: ArrayList<String>, private val clickInstance: ClickInterface.ClickPosInterface): RecyclerView.Adapter<NewImageVideoAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val view= LayoutInflater.from(context).inflate(R.layout.item_image_video, parent, false)

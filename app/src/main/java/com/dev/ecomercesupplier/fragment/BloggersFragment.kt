...
class BloggersFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BloggersFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BloggersFragment().apply {
